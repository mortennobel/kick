...
int TestRay(){
    ...
    bool res;
    res = ray.intersectTriangle(vec3(-1, -1, 0), vec3(-1, 3, 0), vec3(3, -1, 0), intersectionPoint);
    TINYTEST_ASSERT(res);
    res = ray.intersectTriangle(vec3(0), vec3(0, 1, 0), vec3(1, 0, 0), intersectionPoint);
    TINYTEST_ASSERT(res);
    TINYTEST_ASSERT(intersectionPoint == vec3(0,0,0));
    res = ray.intersectTriangle(vec3(0, 1, 0), vec3(0), vec3(1, 0, 0), intersectionPoint);
    TINYTEST_ASSERT(res);
    TINYTEST_ASSERT(intersectionPoint == vec3(0,0,0));
    res = ray.intersectTriangle(vec3(0, 1, 0), vec3(1, 0, 0), vec3(0), intersectionPoint);
    TINYTEST_ASSERT(res);
    TINYTEST_ASSERT(intersectionPoint == vec3(0,0,0));
    ray = Ray{{1,1,10},{0,0,-1}};
    res = ray.intersectTriangle(vec3(0, 0, 0), vec3(2, 0, 0), vec3(0, 2, 0), intersectionPoint);
    TINYTEST_ASSERT(res);
